      ...
      <section className="bg-[#2C3E50] py-16">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6 text-center">
            Reliable Antenna Services – IT Tech
          </h1>
          ...
          <p className="text-white text-lg max-w-4xl mx-auto text-center leading-relaxed">
            At IT Tech, we provide expert TV antenna installations, data
            cabling, NBN relocations, and mobile signal booster solutions.
